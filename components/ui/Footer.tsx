...
export default function Footer() {
  return (
    <footer className="w-full bg-white font-poppins pt-20">
      {/* Top Links Section */}
      <div className="max-w-[1440px] mx-auto px-6 lg:px-20 grid grid-cols-2 lg:grid-cols-4 gap-12 pb-20">
        <div className="space-y-4">
          <h3 className="text-2xl font-bold">Hosting</h3>
          <ul className="space-y-2 text-lg text-slate-700">
            <li>
              <a href="#" className="hover:text-[#004772]">
                Become a host
              </a>
            </li>
            <li>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-8 py-8 border-t border-slate-100">
        <div className="flex items-center gap-2 text-[#004772] font-semibold">
          <Icons.Translation />
      ...
      {/* We place the background color on a parent div that is not constrained by max-width */}
      <div className="w-full bg-[#004772] py-10 mt-4">
