...
const propertyTypes = ['House', 'Flat/Apartment', 'Villa', 'Cottage', 'Hostel', 'Guest House', 'Other'];
const priceRanges = ['₹1,000 - ₹2,500', '₹2,500 - ₹5,000', '₹5,000 - ₹10,000', '₹10,000+'];

export default function PropertyOverviewStep({ formData, onNext }: PropertyOverviewStepProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="space-y-2">
        <h2 className="text-3xl font-light text-blue-950">Tell Us About Your Property</h2>
        <p className="text-stone-600">Help us understand what you're listing</p>
      </div>

      <div className="space-y-4">
        <div>
          <label className="block text-sm font-medium text-blue-950 mb-3">Property Type</label>
          ...
          {errors.propertyType && <p className="text-sm text-red-500 mt-2">{errors.propertyType}</p>}
        </div>

        <div>
          <label className="block text-sm font-medium text-blue-950 mb-2">Area/Locality/Neighborhood</label>
          <input
            type="text"
            value={area}
        ...
        <div>
          <label className="block text-sm font-medium text-blue-950 mb-2">Number of Bedrooms</label>
          <div className="flex items-center gap-4">
            ...
            <span className="text-2xl font-light w-12 text-center">{bedrooms}</span>
            <button
              type="button"
          ...
          {errors.bedrooms && <p className="text-sm text-red-500 mt-2">{errors.bedrooms}</p>}
        </div>

        <div>
          <label className="block text-sm font-medium text-blue-950 mb-3">Estimated Nightly Price Range</label>
          <div className="grid grid-cols-2 gap-2">
          ...
          {errors.priceRange && <p className="text-sm text-red-500 mt-2">{errors.priceRange}</p>}
        </div>
      </div>
